...
// GIFTASTIC! 
var topics = ["Seinfeld", "Friends", "Simpsons", "The Fresh Prince of Bel-Air", "Family Matters", "The Wonder Years", "Full House", "Alf", "Home Improvement", "Roseanne", "Everybody Loves Raymond", "That 70's Show", "3rd Rock from the Sun"];
...
$("#buttonArea").on("click", ".btn", function(){
  		...
  		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + thing + "&api_key=z6KZ4R2y4H3DXFltIUHKbnm4PygXxuSo&limit=10";
